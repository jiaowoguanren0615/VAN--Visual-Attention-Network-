<h1 align='center'>VAN(Visual Attention Network)</h1>

# [Visual Attention Network](https://arxiv.org/pdf/2202.09741.pdf)
This is a warehouse for VAN-pytorch-model, can be used to train your image-datasets for vision tasks..  
...
[pretrained_weights](https://github.com/Visual-Attention-Network/VAN-Classification/tree/main?tab=readme-ov-file#2-van-models-in-1k). 

### Note
```
If you download the pre-trained weights, you should enter train.py and set the 'finetune' parameter for your weights-file path.
```
