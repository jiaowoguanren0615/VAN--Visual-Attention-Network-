...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'VAN training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=16, type=int)
    parser.add_argument('--epochs', default=5, type=int)
    parser.add_argument('--predict', default=True, type=bool, help='plot ROC curve and confusion matrix')

    # Model parameters
    parser.add_argument('--model', default='van_b3', type=str, metavar='MODEL',
                        choices=['van_b0', 'van_b1', 'van_b2', 'van_b3', 'van_b4', 'van_b5', 'van_b6'],
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'VAN training and evaluation script', parents=[get_args_parser()])
