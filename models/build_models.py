...
@register_model
def van_b1(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = VAN(
...
@register_model
def van_b2(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = VAN(
        embed_dims=[64, 128, 320, 512], mlp_ratios=[8, 8, 4, 4],
...
@register_model
def van_b3(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = VAN(
        embed_dims=[64, 128, 320, 512], mlp_ratios=[8, 8, 4, 4],
...
@register_model
def van_b4(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = VAN(
        embed_dims=[64, 128, 320, 512], mlp_ratios=[8, 8, 4, 4],
...
@register_model
def van_b5(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = VAN(
...
@register_model
def van_b6(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = VAN(
